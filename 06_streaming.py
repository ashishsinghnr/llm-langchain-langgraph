"""
Sample 6: Streaming Responses
===============================
Demonstrates streaming LLM output token-by-token instead of waiting
for the full response. This improves perceived latency for users.
...
def example_basic_stream():
    ...
    print("=" * 60)
    print("Example A: Basic LLM streaming")
    print("=" * 60)
...
try:
    with newrelic.agent.BackgroundTask(app, name="streaming", group="LangChain"):
