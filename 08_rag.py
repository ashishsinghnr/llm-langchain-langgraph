"""
Sample 8: RAG — Retrieval Augmented Generation
=================================================
The most common LLM pattern in production. Instead of relying on the
model's training data, we feed it relevant documents at query time.
...
try:
    with newrelic.agent.BackgroundTask(nr_app, name="rag", group="LangChain"):
