"""
Sample 12G: Orchestrator-Worker — Dynamic Parallelism with Send API (Google Gemini)
====================================================================================
Same as 12_orchestrator_worker.py but uses Google's Gemini model.
The Send API and reducer pattern are LangGraph features, not LLM-specific.
...
try:
    with newrelic.agent.BackgroundTask(nr_app, name="orchestrator-worker-google", group="LangChain"):
