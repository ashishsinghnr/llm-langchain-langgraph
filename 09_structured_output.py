"""
Sample 9: Structured Output with Pydantic Models
==================================================
...
Why it matters:
  Without structured output, you parse JSON from free text (fragile).
  With structured output, the LLM is *forced* to match the schema —
  you get a Pydantic object with typed fields, ready to use.
...
try:
    with newrelic.agent.BackgroundTask(app, name="structured-output", group="LangChain"):

        # -------------------------------------------------------------------
        # Example A: Basic extraction — parse a movie review
        # -------------------------------------------------------------------
        print("=" * 60)
        print("Example A: Extract structured data from a movie review")
        print("=" * 60)
